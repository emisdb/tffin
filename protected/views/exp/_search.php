...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'concert_id'); ?>
		<?php echo $form->textField($model,'concert_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'expence_id'); ?>
		<?php echo $form->textField($model,'expence_id'); ?>
	</div>
