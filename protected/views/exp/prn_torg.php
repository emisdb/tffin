...
//Yii::app() ->clientScript -> registerScriptFile(Yii::app()->request->baseUrl."/js/printThis.js", CClientScript::POS_END);
		...
		$this->widget('zii.widgets.CMenu', array(
			'items'=>array(
	array('label'=>'С печатью',  'url'=>'javascript:void(0);' , 'linkOptions'=>array('onclick'=>'doprint(2)'),),
	array('label'=>'Без печати',  'url'=>'javascript:void(0);' , 'linkOptions'=>array('onclick'=>'doprint(3)'),),
	array('label'=>'Pdf', 'url'=>array('pdf', 'id'=>$model->id)),
	array('label'=>$ttwrap.'Почта</span>', 'url'=>array('mail', 'id'=>$model->id)),
),
...
<tbody><tr>
<td width="85">
    <div style="width:85px;font-size:10pt;padding-left:2px;">
Поставщик:
    </div>
</td>
<td>
    <div style="width: 630px; font-weight: bold; font-size: 10pt; padding-left: 2px; background-color: transparent;">
    <?php 
...
<thead>
 <tr id="header">
  ...
  <th style="width:50px;">
    <div style="width:55px;"">Кол - во</div>       
  </th>
  <th style="width:50px;">
    <div style="width:50px;">Ед.</div>         
  </th>
  <th style="width:55px;">
  ...
  <?php if($dis): ?>
  <th style="width:60px;">
    <div style="width:60px;">Сумма без скидки</div>           
  </th>  
  <th style="width:55px;border-right:2px solid;">
    <div style="width:55px;" >Скидка</div>           
  </th> 
    <?php endif; ?>  
  <th style="width:60px;border-right:2px solid;">
    <div style="width:60px;" >Сумма</div>           
  </th>  
 </tr> 
</thead>                
 <tbody>
