...
/*	echo '<div class="row">';
		 ...
		 echo $form->textField($model,'users_id'); 
		 echo $form->error($model,'users_id'); 
	echo '</div>';
	echo '<div class="row">';
		 echo $form->labelEx($model,'dateinserted'); 
		 echo $form->textField($model,'dateinserted'); 
		 echo $form->error($model,'dateinserted'); 
	echo '</div>';
	echo '<div class="row">';
		 echo $form->labelEx($model,'pay'); 
		 echo $form->textField($model,'pay'); 
		 echo $form->error($model,'pay'); 
	echo '</div>';
*/
?>
